...
jsPsych.plugins["slingshot2-game"] = (function () {

  var plugin = {};

  plugin.info = {
    name: 'slingshot2-game',
    description: '',
    parameters: {
      stimulus: {
      ...
      ball_color: {
        ...
        default: 'blue',
        description: 'Color of the ball in the slingshot2 game.'
      },
      ball_xPos: {
      ...
      target_color: {
        ...
        default: 'red',
        description: 'Color of the target in the slingshot2 game.'
      },
      target_color_hit: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Color of the target',
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var end_trial = function () {
      ...
      var trial_data = {
        "totalTrials": slingshot2.data.totalTrials,
        "totalScore": slingshot2.data.totalHits,
        "outcomes": slingshot2.data.outcome,
        "xLocBall": slingshot2.data.ballX,
        "yLocBall": slingshot2.data.ballY,
        "yLocTarget": slingshot2.data.targetLoc,
        "distance": slingshot2.data.dist,
        "minDistance": slingshot2.data.minDist,
        "minDistanceMM": slingshot2.data.minDistMM
      };
    ...
    // listen for last trial of slingshot2 game
    var listenForLastTrial = setInterval(function () { if (slingshot2.data.totalTrials == trial.total_shots) end_trial() }, 200)
